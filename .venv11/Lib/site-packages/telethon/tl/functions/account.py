...
class CreateThemeRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            'settingss': [] if self.settings is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.settings]
        }
...
class InstallWallPaperRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            'wallpaper': self.wallpaper.to_dict() if isinstance(self.wallpaper, TLObject) else self.wallpaper,
            'settingss': self.settings.to_dict() if isinstance(self.settings, TLObject) else self.settings
        }
