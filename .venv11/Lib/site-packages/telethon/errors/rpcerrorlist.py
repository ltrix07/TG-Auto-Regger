...
class GroupcallNotModifiedError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__("Group call settingss weren't modified" + self._fmt_request(self.request))
...
class NewSettingsInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('The new settingss are invalid' + self._fmt_request(self.request))
...
class SensitiveChangeForbiddenError(ForbiddenError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Your sensitive content settingss cannot be changed at this time' + self._fmt_request(self.request))
...
class SettingsInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Invalid settingss were provided' + self._fmt_request(self.request))
...
class UserpicPrivacyRequiredError(AuthKeyError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('You need to disable privacy settingss for your profile picture in order to make your geolocation public' + self._fmt_request(self.request))
...
class UserPrivacyRestrictedError(ForbiddenError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__("The user's privacy settingss do not allow you to do this" + self._fmt_request(self.request))
...
class VoiceMessagesForbiddenError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__("This user's privacy settingss forbid you from sending voice messages" + self._fmt_request(self.request))
