...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        # If config settingss are provided, enforce PEP 517.
        if self.config_settings:
            if self.use_pep517 is False:
                logger.warning(
                    "--no-use-pep517 ignored for %s "
                    "because --config-settingss are specified.",
                    self,
                )
    ...
    def ensure_build_location(
        ...
        # settingss, which is what we actually want when auto-deleting.
        ...
        if self.editable and not self.is_wheel:
            deprecated(
                ...
                replacement=(
                    ...
                    "try using --config-settingss editable_mode=compat. "
            ...
            if self.config_settings:
                logger.warning(
                    "--config-settingss ignored for legacy editable install of %s. "
...
def check_legacy_setup_py_options(
    ...
    if has_build_options or has_global_options:
        deprecated(
            ...
            issue=11859,
            replacement="to use --config-settingss",
            gone_in="25.3",
        )
        logger.warning(
