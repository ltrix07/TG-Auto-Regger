...
def _handlePause(_pause):
    """
    A helper function for performing a pause at the end of a PyAutoGUI function based on some settingss.
...
def _normalizeButton(button):
    ...
    # TODO - We should check the OS settingss to see if it's a left-hand setup, where button 1 would be "right".
