...
class ProxyType:
    ...
    MANUAL = ProxyTypeFactory.make(1, "MANUAL")  # Manual proxy settingss (e.g., for httpProxy).
    ...
    SYSTEM = ProxyTypeFactory.make(5, "SYSTEM")  # Use system settingss (default on Linux).
