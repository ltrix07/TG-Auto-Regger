...
class ButtonUserPrivacyRestricted(BadRequest):
    """The privacy settingss of the user specified in a keyboard button do not allow creating such button"""
...
class ChatNotModified(BadRequest):
    """The chat settingss (title, permissions, photo, etc..) were not modified because you tried to edit them using the same content"""
...
class FreshChangeAdminsForbidden(BadRequest):
    """You can't change administrator settingss in this chat because your session was logged-in recently"""
...
class SettingsInvalid(BadRequest):
    """Invalid settingss were provided"""
    ID = "SETTINGS_INVALID"
    """``str``: RPC Error ID"""
    MESSAGE = __doc__
